  ...
  function layoutLeitor(){
    ...
    HTMLstring+='<span class="fa fa-print"></span> Imprimir</button> <a href="pdf/conteudo-completo.pdf" class="btn btn-primary">\n';
    HTMLstring+='<span class="fa fa-download"></span> Baixar conteúdo</a>\n';
